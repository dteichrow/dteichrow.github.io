...
- Full scratch capture: `/atlases/maritime/?youtube=1&tour=1&pace=2.05`
- Local development capture: `external/maritime_disease_atlas/index.html?youtube=1&tour=1&pace=2.05`
- Single-section capture: `external/maritime_disease_atlas/index.html?youtube=1&scenario=<scenario_id>&pace=2.05`
- Legacy presentation capture remains valid: `?video=1&scenario=<id>&pace=2.05`
...
| --- | ---: | --- | --- | --- |
| Cold open | 0:00-1:00 | `?youtube=1&scenario=pirate_network&pace=2.05` | Map, routes, pirate-network archival plates | Replace "ships carried disease" with "ships made disease ecologies." |
| Pirate infrastructure | 1:00-2:25 | Pirate Ports | Nassau, Port Royal, Tortuga, Cape Fear, quarantine/lazaretto material | Show ports as infrastructure: provisioning, repair, labor, capture, documents, waiting. |
| Vector ecology | 2:25-4:00 | Yellow Fever, Malaria | Warm Atlantic and Caribbean port ecology | Explain that route movement and local vector ecology are not the same claim. |
| Provisions ecology | 4:00-6:00 | Scurvy, Flux, Typhoid | Casks, galley, water, waste, stored food | Move inward from ports to shipboard food-water and diet systems. |
| Crowding/contact | 6:00-7:55 | Ship Fever, Smallpox, Measles | Below-deck crowding, bedding, quarantine, inspection | Make the ship interior legible as epidemiologic architecture. |
| Violence/coercion | 7:55-9:30 | Wounds + Sepsis, Middle Passage | Surgery tools, trauma, forced confinement, Brookes diagram | Treat violence and forced movement as disease ecology, not background context. |
| Close | 9:30-10:00 | `?youtube=1&tour=1&pace=2.05` selected montage | Return to routes, ports, provisions, crowding, coercion | Close on maritime movement as ecological, political, and visible in sources. |
...
### 4:00 - Provisions, Water, And Time
...
This guided tour adapts the cited Maritime Disease Ecology Atlas from The Edge of Epidemiology.
...
- Do not add precise mortality, route, or origin claims in narration unless the claim already exists in the cited exhibit data.
...
- Convict ships and prison hulks: strong future module, but not in the current public exhibit package.
...
- Capture full scratch tour with `?youtube=1&tour=1&pace=2.05`.
