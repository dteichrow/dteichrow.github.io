      ...
      <section class="about-layout">
        <div class="about-block">
          <div class="about-portrait">
            <img class="about-portrait-image" src="{html.escape(link_for(base_url, "assets/visuals/devin-teichrow-portrait.jpg"))}" alt="Devin Teichrow speaking at a podium" loading="lazy" />
            <div>
